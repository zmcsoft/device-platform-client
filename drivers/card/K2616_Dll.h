...
/**********错误代码*********/
#define CardBoxEmpty				0xA0//卡空
#define CardJam						0xA2//卡片堵塞
#define RecycleBoxFull				0xA1//回收箱卡满
#define RecycleBoxNotInPosition		0xA3//回收箱卡满
#define CardBoxNotInPosition		0xA4//发卡箱不到位
#define HookMoveBox1NotEmpty		0xA7//卡箱1 2都有卡，卡钩不能从卡箱2移动,请取出卡箱，重启设备或执行复位命令
#define HookMoveTimeOut				0xA8//卡钩走位传感器没检测到卡钩引起超时
#define MoverMoveError				0xAE//移动平台移动失败
#define PlatformWaitCard			0xAF//平台等待卡片超时
#define PlatformFlipCard			0xB0//平台弹卡失败
#define Hook1MoveFail        		0xB1//移动卡钩1失败
#define Hook2MoveFail        		0xB2//移动卡钩2失败
#define CardIsInPlatform			0xB3//卡片在平台上,不能执行从卡箱发卡或读卡器中回收动作
#define SendCardToPlatformFail		0xB4//发卡到平台失败
#define CardIsNotInPlatform			0xB5//平台上无卡，不能执行回收或发卡到读卡器
#define SendCardFailed				0xC6//发卡失败
#define RecyclePlatformCard			0xC7//回收移动平台上面的卡片
#define RecycleCardFailed			0xC8//回收失败，卡片还在移动平台上面
#define HaveCardAndSendCardFailed	0xC9//读卡器内部有卡，不能发卡
#define HaveNoCardRecycleCardFailed	0xCA//读卡器内部和移动平台无卡，不能回收
...
int __stdcall K2616_EnterCardUntime(HANDLE ComHandle, BYTE EnterType);//;;;进卡立即返回
